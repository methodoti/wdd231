...
const fields = ["first-name", "last-name", "email", "aircraft", "developer", "information", "timestamp"];
...
if (getString !== "") {
    ...
    document.querySelector("#results").innerHTML = `<p>No data received. Please fill the form on the right page!</p>`;
}